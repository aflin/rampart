...
struct evhtp_request {
    ...
    uint64_t cb_has_websock : 1,
             websock        : 1,
             disconnect     : 1,
             ws_cont        : 1,
             ws_opcode      : 4,
             ws_id          : 53;                     /* a counter set id for this websock connection 
                                                         (limited to double positive whole number precision)*/
...
#ifdef EVHTP_VALGRIND_FORK_SAFE
TAILQ_HEAD(connhead_s, evhtp_connection); //-ajf connection tracker
