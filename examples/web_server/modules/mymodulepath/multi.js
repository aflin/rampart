...
since we have 
  ...
  and this module is at modules/mymodulepath/multi.js

the functions below map to
  http://localhost:8088/scripts/multi/
  http://localhost:8088/scripts/multi/index.html
  http://localhost:8088/scripts/multi/page1.html
  http://localhost:8088/scripts/multi/page2.html
  http://localhost:8088/scripts/multi/virtdir/page3.html
*/
