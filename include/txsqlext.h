...
**
**	Updated 5/12/93 for 2.0 specification
*********************************************************************/
...
/* KNG 20091211 from Windows odbcss.h: */
...
/* KNG 20081007 SQL_[C_]TYPE_TIMESTAMP for datetime; MS SQL Server 2005
 * sends datetime as SQL_TYPE_TIMESTAMP, so we will too...:
 */
...
typedef struct tagSQL_NUMERIC_STRUCT
{
  SQLCHAR       precision;
  SQLSCHAR      scale;
  SQLCHAR       sign;           /* 1: pos.  2 (or 0 for ODBC 3.5): neg. */
  SQLCHAR       val[SQL_MAX_NUMERIC_LEN];
}
SQL_NUMERIC_STRUCT;
#  define SQL_NUMERIC_STRUCTPN  ((SQL_NUMERIC_STRUCT *)NULL)
#endif /* ODBCVER >= 0x0300 */
...
#define STMT_OPT_MIN				SQL_QUERY_TIMEOUT
#define STMT_OPT_MAX				SQL_ROW_NUMBER
...
#define SQL_UB_DEFAULT				SQL_UB_ON
...
"ABSOLUTE,ADA,ADD,ALL,ALLOCATE,ALTER,AND,ANY,ARE,AS,"\
"ASC,ASSERTION,AT,AUTHORIZATION,AVG,"\
"BEGIN,BETWEEN,BIT,BIT_LENGTH,BY,CASCADE,CASCADED,CASE,CAST,CATALOG,"\
"CHAR,CHAR_LENGTH,CHARACTER,CHARACTER_LENGTH,CHECK,CLOSE,COALESCE,"\
"COBOL,COLLATE,COLLATION,COLUMN,COMMIT,CONNECT,CONNECTION,CONSTRAINT,"\
"CONSTRAINTS,CONTINUE,CONVERT,CORRESPONDING,COUNT,CREATE,CURRENT,"\
"CURRENT_DATE,CURRENT_TIME,CURRENT_TIMESTAMP,CURSOR,"\
"DATABASE,DATE,DAY,DEALLOCATE,DEC,DECIMAL,DECLARE,DEFERRABLE,DEFERRED,"\
"DELETE,DESC,DESCRIBE,DESCRIPTOR,DIAGNOSTICS,DICTIONARY,DISCONNECT,"\
"DISPLACEMENT,DISTINCT,DOMAIN,DOUBLE,DROP,"\
...
"JOIN,KEY,LANGUAGE,LAST,LEFT,LEVEL,LIKE,LOCAL,LOWER,"\
"MATCH,MAX,MIN,MINUTE,MODULE,MONTH,MUMPS,"\
"NAMES,NATIONAL,NCHAR,NEXT,NONE,NOT,NULL,NULLIF,NUMERIC,"\
"OCTET_LENGTH,OF,OFF,ON,ONLY,OPEN,OPTION,OR,ORDER,OUTER,OUTPUT,OVERLAPS,"\
"PARTIAL,PASCAL,PLI,POSITION,PRECISION,PREPARE,PRESERVE,"\
"PRIMARY,PRIOR,PRIVILEGES,PROCEDURE,PUBLIC,"\
"REFERENCES,RESTRICT,REVOKE,RIGHT,ROLLBACK,ROWS,"\
"SCHEMA,SCROLL,SECOND,SECTION,SELECT,SEQUENCE,SET,SIZE,SMALLINT,SOME,SQL,"\
"SQLCA,SQLCODE,SQLERROR,SQLSTATE,SQLWARNING,SUBSTRING,SUM,SYSTEM,"\
"TABLE,TEMPORARY,THEN,TIME,TIMESTAMP,TIMEZONE_HOUR,TIMEZONE_MINUTE,"\
"TO,TRANSACTION,TRANSLATE,TRANSLATION,TRUE,"\
"UNION,UNIQUE,UNKNOWN,UPDATE,UPPER,USAGE,USER,USING,"\
"VALUE,VALUES,VARCHAR,VARYING,VIEW,WHEN,WHENEVER,WHERE,WITH,WORK,YEAR"
#endif	/* ODBCVER >= 0x0200 */

/* Level 1 Prototypes */
RETCODE SQL_API SQLColumns ARGS((
    HSTMT       hstmt,
...
RETCODE SQL_API SQLDriverConnect ARGS((
    HDBC        hdbc,
    HWND        hwnd,
...
RETCODE SQL_API SQLGetConnectOption ARGS((
    HDBC        hdbc,
    UWORD       fOption,
    PTR         pvParam));

RETCODE SQL_API SQLGetData ARGS((
    HSTMT       hstmt,
    UWORD       icol,
    SWORD       fCType,
    PTR         rgbValue,
...
RETCODE SQL_API SQLGetFunctions ARGS((
    HDBC        hdbc,
    UWORD       fFunction,
    UWORD  FAR *pfExists));

RETCODE SQL_API SQLGetInfo ARGS((
    HDBC        hdbc,
    UWORD       fInfoType,
    PTR         rgbInfoValue,
...
RETCODE SQL_API SQLGetStmtOption ARGS((
    HSTMT       hstmt,
    UWORD       fOption,
    PTR         pvParam));

RETCODE SQL_API SQLGetTypeInfo ARGS((
    HSTMT       hstmt,
    SWORD       fSqlType));

RETCODE SQL_API SQLParamData ARGS((
    HSTMT       hstmt,
    PTR    FAR *prgbValue));

RETCODE SQL_API SQLPutData ARGS((
    HSTMT       hstmt,
    PTR         rgbValue,
    SDWORD      cbValue));

RETCODE SQL_API SQLSetConnectOption ARGS((
    HDBC        hdbc,
    UWORD       fOption,
    UDWORD      vParam));

RETCODE SQL_API SQLSetStmtOption ARGS((
    HSTMT       hstmt,
    UWORD       fOption,
    UDWORD      vParam));

RETCODE SQL_API SQLSpecialColumns ARGS((
    HSTMT       hstmt,
    UWORD       fColType,
    UCHAR  FAR *szTableQualifier,
    SWORD       cbTableQualifier,
...
RETCODE SQL_API SQLStatistics ARGS((
    HSTMT       hstmt,
    UCHAR  FAR *szTableQualifier,
    SWORD       cbTableQualifier,
    UCHAR  FAR *szTableOwner,
...
RETCODE SQL_API SQLTables ARGS((
    HSTMT       hstmt,
    UCHAR  FAR *szTableQualifier,
    SWORD       cbTableQualifier,
    UCHAR  FAR *szTableOwner,
...
/* Level 2 Prototypes */
RETCODE SQL_API SQLBrowseConnect ARGS((
    HDBC        hdbc,
    UCHAR  FAR *szConnStrIn,
    SWORD       cbConnStrIn,
    UCHAR  FAR *szConnStrOut,
...
RETCODE SQL_API SQLColumnPrivileges ARGS((
    HSTMT       hstmt,
    UCHAR  FAR *szTableQualifier,
    SWORD       cbTableQualifier,
    UCHAR  FAR *szTableOwner,
...
RETCODE SQL_API SQLDataSources ARGS((
    HENV        henv,
    UWORD       fDirection,
    UCHAR  FAR *szDSN,
    SWORD       cbDSNMax,
...
RETCODE SQL_API SQLDescribeParam ARGS((
    HSTMT       hstmt,
    UWORD       ipar,
    SWORD  FAR *pfSqlType,
...
RETCODE SQL_API SQLExtendedFetch ARGS((
    HSTMT       hstmt,
    UWORD       fFetchType,
    SDWORD      irow,
    UDWORD FAR *pcrow,
...
RETCODE SQL_API SQLForeignKeys ARGS((
    HSTMT       hstmt,
...
RETCODE SQL_API SQLMoreResults ARGS((
    HSTMT       hstmt));

RETCODE SQL_API SQLNativeSql ARGS((
    HDBC        hdbc,
...
RETCODE SQL_API SQLNumParams ARGS((
    HSTMT       hstmt,
    SWORD  FAR *pcpar));

RETCODE SQL_API SQLParamOptions ARGS((
    HSTMT       hstmt,
    UDWORD      crow,
    UDWORD FAR *pirow));

RETCODE SQL_API SQLPrimaryKeys ARGS((
    HSTMT       hstmt,
    UCHAR  FAR *szTableQualifier,
    SWORD       cbTableQualifier,
    UCHAR  FAR *szTableOwner,
...
RETCODE SQL_API SQLProcedureColumns ARGS((
    HSTMT       hstmt,
...
RETCODE SQL_API SQLProcedures ARGS((
    HSTMT       hstmt,
    UCHAR  FAR *szProcQualifier,
    SWORD       cbProcQualifier,
    UCHAR  FAR *szProcOwner,
...
RETCODE SQL_API SQLSetPos ARGS((
    HSTMT       hstmt,
    UWORD       irow,
    UWORD       fOption,
    UWORD       fLock));

RETCODE SQL_API SQLTablePrivileges ARGS((
    HSTMT       hstmt,
    UCHAR  FAR *szTableQualifier,
    SWORD       cbTableQualifier,
    UCHAR  FAR *szTableOwner,
...
#if (ODBCVER >= 0x0200)
RETCODE SQL_API SQLDrivers ARGS((
    HENV        henv,
    UWORD       fDirection,
...
RETCODE SQL_API SQLBindParameter ARGS((
    HSTMT       hstmt,
	UWORD		ipar,
	SWORD		fParamType,
    SWORD       fCType,
...
RETCODE SQL_API SQLSetScrollOptions ARGS((	/*	Use SQLSetStmtOptions */
    HSTMT       hstmt,
    UWORD       fConcurrency,
    SDWORD      crowKeyset,
	UWORD		crowRowset));
...
RETCODE SQL_API SQLFetchScroll ARGS((
	HSTMT	hstmt,
	SWORD	direction,
	SDWORD	offset));
