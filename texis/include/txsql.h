...
/* If ODBCVER is not defined, assume version 3.5 */
#ifndef ODBCVER
...
#define SQL_SPEC_STRING 	"03.50" /* String constant for version	   */
#elif (ODBCVER >= 0x0200)
#define SQL_SPEC_MAJOR			  2 /* Major version of specification  */
#define SQL_SPEC_MINOR			  0 /* Minor version of specification  */
...
#define	COLATT_OPT_MIN  SQL_COLUMN_COUNT
#define COLATT_OPT_MAX	SQL_COLUMN_LABEL
...
#if defined(_WIN32) || !defined(__STDC__) || defined(__osf__) || defined(__APPLE__)
