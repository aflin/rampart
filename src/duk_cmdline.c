...
static void print_greet_line_duk(void) {
...
static void print_greet_line(void) {
	...
	printf("   \\  |  /         \\   /\n");
	printf("    | ^ |          | ^ |  \n");
	printf("  __| o |__________| o |__\n");
	printf(" [__|_|__|(rp)|  | |______]\n");
	printf("_[|||||||||||||__|||||||||]_\n");
	putchar('\n');
	printf("javascript engine powered by:\n");
	print_greet_line_duk();
}
...
void duk_init_userfunc(duk_context *ctx) {
