/* linenoise_wtab.h -- display-width tables for linenoise.c
 *
 * Generated from the Unicode Character Database, version 14.0.0.
 *   zero width : general categories Mn, Me, Cf (except U+00AD) and the
 *                Hangul Jamo medial/final range U+1160..U+11FF
 *   wide       : East_Asian_Width W or F
 * Intervals are sorted and inclusive; look up with a binary search.
 */
#ifndef LINENOISE_WTAB_H
#define LINENOISE_WTAB_H

struct ln_interval { unsigned int first, last; };

static const struct ln_interval ln_zero_width[] = {
    ...
    {0x11D97, 0x11D97}, {0x11EF3, 0x11EF4}, {0x13430, 0x13438}, {0x16AF0, 0x16AF4},
    ...
    {0x1E130, 0x1E136}, {0x1E2AE, 0x1E2AE}, {0x1E2EC, 0x1E2EF}, {0x1E8D0, 0x1E8D6},
    {0x1E944, 0x1E94A}, {0xE0001, 0xE0001}, {0xE0020, 0xE007F}, {0xE0100, 0xE01EF},
};

static const struct ln_interval ln_wide[] = {
