...
"  /* node attaches a .native variant on the async realpath too; alias\n"
"     it to the same impl so probes like fs-extra's fs.realpath.native\n"
"     fingerprint find it (we have no separate native/JS impls). */\n"
